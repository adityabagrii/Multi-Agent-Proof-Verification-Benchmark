# Cauchy-Schwarz Inequality - repaired run 2
...
4.  **Discriminant Analysis:**
    For a quadratic $At^2 + Bt + C \geq 0$ to hold for all $t$, the quadratic coefficient $A$ must be positive, and the discriminant $\Delta = B^2 - 4AC$ must satisfy $\Delta \leq 0$.
    Here, $A = \sum b_i^2 > 0$, $B = -2\sum a_i b_i$, and $C = \sum a_i^2$.
5.  **Calculate $\Delta$:**
